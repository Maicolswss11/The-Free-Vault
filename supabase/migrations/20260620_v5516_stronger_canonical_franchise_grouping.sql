-- Ludograph v5.5.16 — raggruppamento canonico rafforzato nell'editor franchise.
--
...
-- La v5.5.16 rafforza il raggruppamento title+anno vicino anche quando
-- una variante e' classificata come remake/remaster o quando l'anno e'
-- disponibile solo su una parte dei record dello stesso titolo.
  ...
  with candidate_keys as materialized (
    ...
    select
      ...
      case
        ...
        -- v5.5.16: stesso titolo normalizzato + anno compatibile = stessa
        -- opera canonica nell'editor franchise, anche se una delle varianti
        -- e' stata classificata diversamente dal provider.
...
comment on function public.admin_search_franchise_candidates(text, integer) is
  'Ludograph v5.5.16: ricerca admin franchise su opere canoniche; unisce anche gruppi duplicati con stesso titolo e anno compatibile.';
